@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=C:\Users\EgronGT\Desktop\Wordpress\php"
...
FOR %%x IN ("C:\Users\EgronGT\Desktop\Wordpress\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Users\EgronGT\Desktop\Wordpress\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Users\EgronGT\Desktop\Wordpress\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Users\EgronGT\Desktop\Wordpress\php\php.exe"
GOTO :INSTALLED
